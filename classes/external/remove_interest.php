...
/**
 * Remove an interest tag from the current user.
 *
 * @package    block_profile_completion
 * @copyright  2026 LearnByWatch
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class remove_interest extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'tag' => new external_value(PARAM_TAG, 'Interest tag to remove'),
        ]);
    }
    ...
    public static function execute(string $tag): array {
        ...
        profile_manager::remove_interest((int) $USER->id, $tag);
